...
=== **Module 1:** Introduction to your environment and Model-as-a-Service Infrastructure
...
Set up OpenShift Dev Spaces, install an AI code assistant, and connect it to your private MaaS model endpoint to enhance your coding workflow.

=== **Module 3:** Game Time
Build a simple game using Continue's AI assistance. Explore, experiment, and build confidence with AI-assisted coding through a fun, low-pressure project.

=== **Module 4:** System Administration with Agentic AI
With the mindset of a site reliability engineer or DevOps practitioner, use Model Context Protocol (MCP) servers and LlamaStack to interact with your OpenShift cluster and Slack workspace using natural language.
