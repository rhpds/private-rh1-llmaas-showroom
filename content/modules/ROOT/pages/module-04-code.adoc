...
image::game_starters.png[width="50%"]
...
image::toggle_sidebar.png[width="80%"]
...
image::continue_popup.png[width="80%"]
...
We will use the Terminal capability within VSCode to test our applications. To open a terminal session navigate to `Terminal` -> `New Terminal` from the hamburger menu in the navigation bar of the VSCode app. Or you may press kbd:[Ctrl+\`].
